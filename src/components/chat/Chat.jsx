...
const Chat = ({
  ...
  return (
    <div
      className={`${isFullscreen ? "fixed inset-0 z-50" : "h-full"} flex flex-col overflow-hidden transition-all duration-700 ${
        darkMode
    ...
    >
      ...
      {/* HEADER */}
      <div
        className={`p-4 sm:p-5 border-b flex flex-col lg:flex-row lg:justify-between lg:items-center gap-3 sm:gap-4 relative z-20 ${
          darkMode
          ...
          <div className="flex items-start sm:items-center gap-3 mb-2 sm:mb-3">
            ...
            <div className="flex-1 min-w-0 overflow-hidden">
              <div className="flex items-center gap-2 mb-1 flex-wrap">
                ...
                />
                <h3
                  className={`font-bold text-base sm:text-lg truncate bg-gradient-to-r bg-clip-text text-transparent ${
                    darkMode
              ...
              <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                ...
                >
                  ...
                  />
                  <p
                    className={`text-xs sm:text-sm font-medium truncate max-w-[150px] sm:max-w-none ${darkMode ? "text-gray-300" : "text-gray-700"}`}
                  >
      ...
      {pinnedMessages.length > 0 && (
        <div
          className={`px-4 sm:px-5 py-2 sm:py-3 border-b flex items-center gap-2 sm:gap-3 overflow-x-auto scrollbar-hide relative z-10 ${
            darkMode
      ...
      >
        ...
        {loading ? (
          <div className="space-y-6 sm:space-y-8 animate-pulse w-full">
            ...
            <div className="flex justify-start items-end gap-2.5 max-w-[85%] sm:max-w-[70%]">
              <div
            ...
            <div className="flex justify-end items-end gap-2.5 max-w-[85%] sm:max-w-[70%] ml-auto">
          ...
          <>
            {messages.length === 0 && (
              <div className="h-full flex flex-col items-center justify-center p-4 sm:p-6 text-center">
                <div
                  className={`p-6 sm:p-8 rounded-2xl sm:rounded-3xl mb-6 sm:mb-8 transition-all duration-700 hover:scale-[1.02] relative overflow-hidden ${
                    darkMode
              ...
              return (
                ...
                >
                  <div className="flex justify-center my-6 sm:my-8 sticky top-4 z-20">
                    <div
                      className={`text-xs sm:text-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full backdrop-blur-xl border transition-all duration-500 hover:scale-105 shadow-lg flex items-center gap-3 ${
                    ...
                    if (isSystem) {
                      return (
                        <div key={msg._id} className="flex justify-center">
                          <div
                            className={`text-xs sm:text-sm px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl border flex items-center gap-3 sm:gap-4 max-w-full sm:max-w-md backdrop-blur-xl ${
                              darkMode
        ...
        {isTyping && (
          <div className="flex justify-start">
            <div
              className={`p-4 sm:p-5 rounded-2xl sm:rounded-3xl max-w-[85%] sm:max-w-[70%] backdrop-blur-xl shadow-2xl ${
                darkMode
      ...
      <div
        className={`p-4 sm:p-5 border-t transition-all duration-500 relative z-20 ${
          darkMode
      ...
      >
        ...
        {userTickets && userTickets.length > 0 && onTicketSelect && (
          <div className="mb-3 flex items-center justify-between">
            <span
              className={`text-xs font-semibold uppercase tracking-wider ${darkMode ? "text-gray-400" : "text-gray-500"}`}
            >
              Replying To:
            </span>
                ...
                {userTickets
                  ...
                  .map((t) => (
                    <option
                      ...
                      value={t._id}
                      disabled
                      className={`${darkMode ? "bg-gray-800 text-gray-500" : "bg-gray-100 text-gray-400"}`}
                    >
        ...
        {ticket?.status === "CLOSED" ? (
          ...
          <>
            ...
            {selectedFiles.length > 0 && (
              <div
                className={`-mx-4 sm:-mx-5 px-4 sm:px-5 pb-4 mb-4 border-b ${darkMode ? "border-gray-800/50" : "border-gray-200/50"} animate-in slide-in-from-bottom-2 duration-200`}
              >
            ...
            >
              <div className="flex-1 relative">
                ...
                <textarea
                  ...
                  rows={1}
                  className={` w-full pl-12 pr-4 py-3 rounded-xl resize-none scrollbar-hide transition-all duration-300 ${
                    darkMode
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-3 sm:mt-4 text-xs gap-2 sm:gap-0">
              <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                ...
                >
                  <Zap className="w-2.5 h-2.5 sm:w-3 sm:h-3" /> Press Enter to
                  send
                </span>
                <span
                  className={`hidden sm:block ${darkMode ? "text-gray-600" : "text-gray-300"}`}
                >
                  •
                </span>
                <span
                  className={`flex items-center gap-1 ${darkMode ? "text-gray-500" : "text-gray-400"}`}
                >
                  <Feather className="w-2.5 h-2.5 sm:w-3 sm:h-3" /> Shift +
                  Enter for new line
                </span>
              </div>
            </div>
      ...
      {isStaffModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal Card */}
          <div
            className={`relative w-full max-w-md rounded-2xl border p-5 shadow-2xl transition-all transform scale-100 duration-300 flex flex-col max-h-[80vh] animate-fade-in ${
              darkMode
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between pb-3 border-b border-gray-700/20 mb-4">
                ...
                .map((s) => {
                  ...
                  return (
                    <div
                      ...
                      className={`w-full flex flex-col p-3 rounded-xl border text-left transition-all duration-300 ${
                        isCurrentlyAssigned
                          ? darkMode
...
const MessageBubble = ({
  ...
  return (
    <div className={`flex ${isAgent ? "justify-end" : "justify-start"}`}>
      <div
        className={`group relative p-4 sm:p-5 rounded-2xl sm:rounded-3xl max-w-[90%] sm:max-w-[85%] md:max-w-[70%] transition-all duration-700 hover:scale-[1.01] ${
      ...
      >
        <div
          className={`absolute -top-3 ${isAgent ? "-left-8 sm:-left-12" : "-right-8 sm:-right-12"} 
        ...
        {msg.attachments?.length > 0 && (
          <div
            className={`grid grid-cols-1 gap-2 ${msg.message ? "mb-2" : ""}`}
          >
