...
const MySubscribers = () => {
  ...
  const fetchCustomers = async (pageNumber) => {
    try {
      ...
      const pagination =
        res.pagination || res.meta?.pagination || res.meta || {};
  ...
  return (
    <div
      className={`rounded-xl shadow-lg border flex flex-col h-full ${
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 items-stretch sm:items-center w-full md:w-auto min-w-0">
          ...
          <div
            ref={filterRef}
            className="flex flex-col sm:flex-row gap-3 relative items-stretch sm:items-center w-full md:w-auto min-w-0"
          >
            ...
            {showFilter && (
              <div
                className={`absolute left-0 right-0 sm:left-auto sm:right-0 top-12 w-full sm:w-72 p-4 rounded-xl shadow-2xl border z-50 animate-in fade-in zoom-in duration-150
      ...
      <div className="flex-1 p-6">
              ...
              <table className="w-full text-left">
                <thead>
                  ...
                  >
                    ...
                    <th
                      className={`py-4 px-6 text-xs font-semibold uppercase tracking-wider text-right ${
                        isDark ? "text-slate-400" : "text-gray-600"
                      }`}
                    >
                      Actions
                  ...
                  {subscribers.map((sub) => (
                    ...
                    >
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-10 h-10 rounded-full bg-blue-500/10 text-blue-400 flex items-center justify-center font-bold text-sm flex-shrink-0 ${
                              isDark
        ...
        {!loading && subscribers.length > 0 && (
          <div
            className={`mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t ${
              isDark ? "border-slate-800" : "border-gray-200"
            }`}
          >
            <div
      ...
      {editModal &&
        ...
        createPortal(
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div
              className={`rounded-xl shadow-2xl w-full max-w-md animate-in fade-in zoom-in duration-200 border ${
                isDark
            ...
            >
              <div
                className={`p-4 border-b flex justify-between items-center rounded-t-xl ${
                  isDark
              ...
              <div
                className={`p-4 border-t flex gap-3 justify-end rounded-b-xl ${
                  isDark
                    ? "border-slate-800 bg-slate-900"
                    : "border-gray-200 bg-white"
                }`}
      ...
      {viewModal && selectedCustomer && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div
            className={`rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-200 border ${
              isDark
                ? "bg-slate-900 border-slate-800"
                : "bg-white border-gray-200"
            }`}
            ...
            {loadingDetails ? (
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-4 pb-4 border-b">
                  <div
                    className={`w-16 h-16 rounded-full bg-blue-500/10 text-blue-400 flex items-center justify-center font-bold text-xl flex-shrink-0 ${
                      isDark
                        ? "ring-2 ring-blue-500/20"
                        : "ring-2 ring-blue-500/10"
                    }`}
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        {viewCustomerDetails.userType === "business"
                          ? "Business"
                          : "Home"}
                      </p>
                      <p
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      ...
                      >
                        ...
                        {viewCustomerDetails.installationAddress?.line2 ||
                          "N/A"}
                      </p>
                      <p
                        className={`text-sm ${
                      ...
                      >
                        ...
                        {viewCustomerDetails.installationAddress?.state ||
                          "N/A"}
                      </p>
                      <p
                        className={`text-sm ${
                      ...
                      >
                        ...
                        {viewCustomerDetails.installationAddress?.country ||
                          "N/A"}
                      </p>
                    </div>
                  </div>
                  ...
                  {viewCustomerDetails.documents && (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {Object.entries(viewCustomerDetails.documents).map(
                          ([key, value]) =>
                            value && (
                              <a
                                key={key}
      ...
      {addModal &&
        createPortal(
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div
              className={`scrollbar-hide rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-200 border ${
                isDark
                  ? "bg-slate-900 border-slate-800"
                  : "bg-white border-gray-200"
              }`}
            >
              ...
              <div className="p-6 space-y-4">
                <div>
                  {/* Personal Info */}
                  <h4
                    className={`text-base font-bold uppercase mt-2 ${isDark ? "text-slate-500" : "text-gray-500"}`}
                  >
                    Personal Information
                  </h4>
