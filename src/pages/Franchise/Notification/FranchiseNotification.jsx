...
export default function FranchiseNotifications() {
  ...
  const fetchUnreadCount = useCallback(async () => {
    try {
      ...
      console.error("Failed to fetch franchise unread count", err);
    }
  }, []);
  ...
  const fetchNotifications = useCallback(async (page = 1, activeFilter) => {
    ...
    try {
      ...
      const isRead =
        ...
        : undefined;
      const { data, meta } = await getFranchiseNotifications(page, ITEMS_PER_PAGE, isRead);
  ...
  const markAllAsRead = useCallback(async () => {
    ...
    setProcessingIds(
      new Set(notifications.filter((n) => n.unread).map((n) => n._id)),
    );
    try {
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div className="relative">
                ...
                <div className="relative flex items-center gap-4">
                  <div className="relative">
                    <div
                      className={`absolute inset-0 ${isDark ? "bg-purple-500/20" : "bg-purple-100"} rounded-2xl blur-xl`}
                    ></div>
                    <div
                    ...
                    >
                      ...
                      <div className="flex items-start gap-5">
                        ...
                        <div className="relative flex-shrink-0">
                          <div
                            className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${getIconGradient(n.category)} 
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-4 flex-wrap">
                            <div className="flex-1">
                              ...
                              <p
                                className={`mt-1 text-sm ${isDark ? "text-white/60" : "text-gray-600"}`}
                              >
                                {n.message}
                              </p>
                            </div>
                          ...
                          {n.description && (
                            <p
                              className={`mt-2 text-sm line-clamp-2 ${isDark ? "text-white/50" : "text-gray-500"}`}
                            >
                              {n.description}
                            </p>
                          )}
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${getIconGradient(selectedNotification.category)} 
