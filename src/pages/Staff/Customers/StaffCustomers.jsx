    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <section>
            <h4
              className={`text-sm font-bold mb-4 ${isDark ? "text-slate-300" : "text-gray-700"}`}
            >
              Basic Information
            </h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {formData.activationDate === "custom" && (
                <Field label="Custom Activation">
                  <input
                    type="datetime-local"
                    name="customActivationDate"
                    value={formData.customActivationDate}
                    onChange={handleInput}
                    className={inputCls(isDark)}
                  />
                </Field>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Field label="Address Line 2" className="sm:col-span-2">
                <input
                  ...
                  value={formData.installation_address_line2}
                  onChange={handleInput}
                  className={inputCls(isDark)}
              ...
              <Field label="PIN Code">
                <input
                  ...
                  value={formData.installation_address_pin}
                  onChange={handleInput}
                  className={inputCls(isDark)}
                  placeholder="PIN"
                />
              ...
              <Field label="State">
                <input
                  ...
                  value={formData.installation_address_state}
                  onChange={handleInput}
                  className={inputCls(isDark)}
                  placeholder="State"
                />
              ...
              <Field label="Country">
                <input
                  ...
                  value={formData.installation_address_country}
                  onChange={handleInput}
                  className={inputCls(isDark)}
                  placeholder="IN"
                />
          ...
          {showFilter && (
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  <label
                    className={`block text-sm font-medium mb-1.5 ${isDark ? "text-slate-300" : "text-gray-700"}`}
                  >
                    Plan
                  </label>
                  <select
      ...
      <div className="flex-1 flex flex-col min-h-0 p-6">
        {loading ? (
          ...
          <>
            ...
            >
              <div className="scrollbar-hide overflow-x-auto h-full">
                <table className="w-full text-left min-w-max">
                  <thead>
                    ...
                    >
                      {["Customer", "Contact", "Plan", "Status", "Actions"].map(
                        (h) => (
                          <th
                            key={h}
                        ...
                        >
                          <td className="py-4 px-6">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="min-w-0">
                                ...
                                <div
                                  className={`text-xs mt-0.5 ${isDark ? "text-slate-500" : "text-gray-500"}`}
                                >
                                  {sub.id?.slice(0, 8)}...
                                </div>
                              </div>
                          ...
                          <td className="py-4 px-6 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              <button
                                onClick={() =>
                                  navigate(`/staff-customer/${sub._id}`)
                                }
                                className={`p-2 rounded-lg ${
                                  isDark
            ...
            {totalItems > 0 && (
              ...
              >
                <div className="flex items-center gap-4 text-sm">
                  ...
                  <div
                    className={`ml-6 ${isDark ? "text-slate-300" : "text-gray-600"}`}
                  >
                    Showing{" "}
                    ...
                    to{" "}
                    <span className="font-semibold">{paginationInfo.end}</span>{" "}
                    ...
                    .map((page, idx, arr) => {
                      ...
                      return (
                        <React.Fragment key={page}>
                          {showEllipsis && (
                            <span
                              className={`px-2 ${isDark ? "text-slate-500" : "text-gray-400"}`}
                            >
                              ...
                            </span>
                          )}
