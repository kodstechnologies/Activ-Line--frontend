...
const GeneralSettings = ({
        ...
        <div className="animate-pulse space-y-8">
          {[1, 2, 3].map((i) => (
            <div key={i} className="space-y-3">
              <div
                className={`h-5 ${isDark ? "bg-gray-700" : "bg-gray-200"} rounded-lg w-1/4`}
              ></div>
              <div
                className={`h-12 ${isDark ? "bg-gray-700" : "bg-gray-200"} rounded-xl`}
              ></div>
            </div>
          ))}
          <div className="flex justify-end gap-3">
            <div
              className={`h-12 w-32 ${isDark ? "bg-gray-700" : "bg-gray-200"} rounded-xl`}
            ></div>
            <div
              className={`h-12 w-40 ${isDark ? "bg-gray-700" : "bg-gray-200"} rounded-xl`}
            ></div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="w-full">
      ...
      {showHeader && (
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            <div
              className={`p-2.5 rounded-xl ${isDark ? "bg-gradient-to-br from-blue-500/20 to-purple-500/20" : "bg-gradient-to-br from-purple-100 to-indigo-100"}`}
            >
              <Sparkles
      ...
      {uiState.error && (
        <div
          className={`mb-6 p-4 rounded-xl border animate-shake ${
            isDark
              ...
              {uiState.hasProfile && (
                <button
                  ...
                  className={`w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl transition-all duration-300 font-medium ${
                    isDark
                      ? "border border-red-400 text-white bg-red-500 hover:bg-red-600 hover:scale-105 hover:shadow-lg"
