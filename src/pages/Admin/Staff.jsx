        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="w-full lg:w-auto flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3">
            ...
            <motion.div
              ...
              className={`relative w-full sm:w-72 ${isDark ? "text-slate-300" : "text-gray-600"}`}
            >
                  ...
                  {Array.from({ length: ITEMS_PER_PAGE }).map((_, i) => (
                    <tr key={i} className="animate-pulse">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-10 h-10 rounded-full ${isDark ? "bg-slate-800" : "bg-gray-200"}`}
                          />
                          <div className="space-y-2">
                            <div
                              className={`h-3.5 w-28 rounded ${isDark ? "bg-slate-800" : "bg-gray-200"}`}
                            />
                            <div
                              className={`h-3 w-20 rounded ${isDark ? "bg-slate-800" : "bg-gray-200"}`}
                            />
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div
                          className={`h-3.5 w-44 rounded ${isDark ? "bg-slate-800" : "bg-gray-200"}`}
                        />
                      </td>
                      <td className="px-6 py-4">
                        <div
                          className={`h-7 w-24 rounded-full ${isDark ? "bg-slate-800" : "bg-gray-200"}`}
                        />
                      </td>
                      <td className="px-6 py-4">
                        <div
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <div
                            className={`h-8 w-8 rounded-lg ${isDark ? "bg-slate-800" : "bg-gray-200"}`}
                          />
                          <div
                            className={`h-8 w-8 rounded-lg ${isDark ? "bg-slate-800" : "bg-gray-200"}`}
                          />
                ...
                >
                  {paginatedStaffs.map((staff, index) => (
                    ...
                    >
                      ...
                      <td
                        className={`px-6 py-4 text-sm truncate max-w-[200px] ${isDark ? "text-slate-300" : "text-gray-600"}`}
                        title={staff.email}
                      >
                        {staff.email}
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <motion.span
                            ...
                            transition={{ duration: 0.5 }}
                            className={`p-1.5 rounded-lg flex-shrink-0 ${isDark ? "bg-slate-800" : "bg-gray-100"}`}
                          >
          ...
          ${
            isDark
              ...
              >
                {/* Header */}
                <div
                  className={`px-4 py-4 sm:px-6 sm:py-5 flex justify-between items-center border-b
            ${isDark ? "border-slate-700/60" : "border-gray-200/70"}`}
                >
                  <div className="flex items-center gap-2.5 sm:gap-3">
                    <motion.div
                      ...
                      className={`p-2 sm:p-3 rounded-xl shadow-inner
              ...
              ${isDark ? "text-slate-400 hover:bg-slate-800" : "text-gray-400 hover:bg-gray-100"}`}
                  >
                    <XCircle className="w-5.5 h-5.5 sm:w-6 sm:h-6" />
                  </motion.button>
                </div>
