  ...
  >
    <div className="flex items-center justify-between">
      <div className="flex-1">
        <div
          className={`h-3 w-20 ${isDark ? "bg-slate-700" : "bg-gray-200"} rounded mb-2`}
        ></div>
        <div
          className={`h-8 w-24 ${isDark ? "bg-slate-700" : "bg-gray-200"} rounded`}
        ></div>
      </div>
      <div
        className={`w-10 h-10 rounded-full ${isDark ? "bg-slate-700" : "bg-gray-200"}`}
      ></div>
    </div>
  </div>
);
...
const BillingPage = () => {
  ...
  const stats = useMemo(() => {
    ...
    const pendingCount =
      summaryCounts.pending || totals.pendingPaymentCount || 0;
  ...
  const uiRows = useMemo(() => {
    return paginationData.paginatedTransactions.map((tx) => {
      ...
      const planEndDate =
        tx.planEndDate ||
        tx?.plan?.planEndDate ||
        addDays(rawDate, tx.planPeriodDays || tx?.plan?.planPeriodDays);
      ...
      >
        ...
        <div className="relative p-6 md:p-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 w-full lg:w-auto relative">
              ...
              <button
                ...
                disabled={loading}
                className={`flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-2.5 rounded-xl border transition-all duration-200 text-sm
                ...
                <AnimatePresence>
                  {showFilter && (
                    <motion.div
                      ...
                      className={`absolute left-1/2 -translate-x-1/2 sm:left-auto sm:right-0 sm:translate-x-0 top-14 md:top-12 w-[calc(100vw-32px)] sm:w-80 p-5 rounded-xl shadow-2xl border z-50 ${
                        isDark
                    ...
                    >
                      ...
                      <label
                        className={`text-sm font-semibold mb-2 block ${isDark ? "text-slate-400" : "text-gray-600"}`}
                      >
                        Status
                      </label>
                      <select
                      ...
                      {franchiseError && (
                        <div
                          className={`mt-3 text-sm ${isDark ? "text-yellow-300" : "text-yellow-700"}`}
                        >
                          {franchiseError}
                        </div>
                      )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`p-2 rounded-xl ${isDark ? "bg-emerald-500/10" : "bg-emerald-100"}`}
                  >
                    <TrendingUp
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`p-2 rounded-xl ${isDark ? "bg-green-500/10" : "bg-green-100"}`}
                  >
                    <CreditCard
              ...
              {loading ? (
                ...
                uiRows.map((tx, index) => (
                  ...
                  >
                    ...
                    <td
                      className={`py-4 px-6 font-medium text-sm ${isDark ? "text-white" : "text-gray-900"}`}
                    >
                    ...
                    <td
                      className={`py-4 px-6 text-sm ${isDark ? "text-slate-300" : "text-gray-700"}`}
                    >
                      {tx.plan}
                    </td>
                    <td
                      className={`py-4 px-6 font-bold text-sm ${isDark ? "text-white" : "text-gray-900"}`}
                    >
                      {tx.amount}
                    </td>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <CreditCard
                        className={`w-5 h-5 ${isDark ? "text-blue-400" : "text-purple-600"}`}
                      />
                    </div>
                    <h3
                ...
                <div className=" scrollbar-hide p-6 space-y-4 overflow-y-auto max-h-[calc(90vh-80px)]">
                  {selectedPayment?.error ? (
                    <p
                      className={`text-base ${isDark ? "text-red-300" : "text-red-700"}`}
                    >
                      {selectedPayment.error}
                    </p>
                  ) : (
                    <>
                      ...
                      <div
                        className={`p-4 rounded-xl ${isDark ? "bg-slate-800/50 text-slate-300" : "bg-gray-50 text-gray-700"}`}
                      >
                        <h4
                          className={`text-sm font-semibold mb-3 flex items-center gap-2 ${isDark ? "text-slate-300" : "text-gray-700"}`}
                        >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                          <p>
                            ...
                            {getCustomerName(selectedPayment?.customer, "--")}
                          </p>
                          <p>
